...
python -c "import requests;a=requests.get('http://download.gnome.org/sources/pango/${PANGO_VERSION%.*}/pango-${PANGO_VERSION}.tar.xz');asset a.status_code != 404;b=open('pango-${PANGO_VERSION}.tar.xz','wb');b.write(a.content);print('done')"
